    ...
    <div class="container position-relative">
        ...
        <nav class="navbar">
            ...
            <div class="site-menu">
                ...
                <li><a <?php if(basename($_SERVER['PHP_SELF']) === 'about.php') echo 'class="active"'; ?> href="about.php">About Us</a></li>
                    ...
                    <li><a <?php if(basename($_SERVER['PHP_SELF']) === 'initiatives.php') echo 'class="active"'; ?> href="initiatives.php">initiatives</a></li>
